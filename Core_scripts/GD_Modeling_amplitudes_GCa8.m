...
% x 1. Simulate calcium traces with gradient descent for GCaMP8 datasets
% x 2. Extract all amplitudes and median amplitude of each neuron
% x 3. Present statistics and plot all extracted amplitudes
...
for neuron_idx = 1:num_neurons
    ...
    for recording_idx = 1:num_recordings
        ...
        % store all amplitudes from each recording
    ...
    % store median amplitude of each neuron
